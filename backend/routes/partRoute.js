...
const { AddPart, getParts, addToInventory, dispatchPart, getPartById, getInventoryPartById, uploadDispatchPDF, UploadImage, getScannedQRIds, checkQRIdExists, updatePart, bulkRemoveQRIds } = require('../controllers/partController');
